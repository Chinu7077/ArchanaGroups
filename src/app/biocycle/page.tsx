...
import BiomassBenefits from '@/features/biocycle/components/BiomassBenefits';
import BiomassProcess from '@/features/biocycle/components/BiomassProcess';
import CleanEnergySection from '@/features/biocycle/components/CleanEnergySection';
import HeroSection from '@/features/biocycle/components/HeroSection';
import IndustriesServed from '@/features/biocycle/components/IndustriesServed';
import ProductSpecifications from '@/features/biocycle/components/ProductSpecifications';
import SellRawMaterial from '@/features/biocycle/components/SellRawMaterial';
import SustainabilitySection from '@/features/biocycle/components/SustainabilitySection';
import Contact from '@/features/biocycle/components/contact';
...
export default function BiomassWebsite() {
  ...
  return (
    <div className="scrollbar-bicycle h-screen overflow-x-hidden overflow-y-scroll">
      {/* ✅ SEO Head Meta Tags */}
      <Head>
        <title>
          Archana BioCycle | Clean Fuel & Red Mud Transport in Odisha
        </title>
        <meta
          name="description"
